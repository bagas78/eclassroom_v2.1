    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
         ...
         <form class="form-row" action="<?php echo base_url('pre/insert') ?>" method="post" enctype="multipart/form-data">

          <input type="hidden" name="pre_semester" value="<?php echo $semester ?>">
          <input type="hidden" name="pre_pertemuan" value="<?php echo $pertemuan ?>">

          <div class="form-group col-md-6">
              <label>Materi</label>
              <input required="" type="text" name="pre_judul" class="form-control"> 
            </div>
           ...
           <div class="form-group col-md-4">
            ...
            <div class="form-group col-md-4">
              ...
              <input required="" type="datetime-local" name="pre_pelaksanaan" class="form-control"> 
            </div>
            
            <div class="form-group col-md-4">
              <label>Durasi</label>
              <input required="" type="number" name="pre_durasi" class="form-control"> 
            </div>

            <div class="form-group col-md-12">
              <label>Petunjuk Pengerjaan</label>
              <textarea required="" class="form-control" name="pre_petunjuk"></textarea>
            </div>

           <div hidden="" class="form-group col-md-3">
             <label>ID Soal</label>
             <input value="<?php echo $idsoal ?>" type="text" name="pre_id" class="form-control">
           </div>
