    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border"> 
            ...
            <div align="left" > 
              <a href="<?php echo base_url('pre'); ?>"><button class="btn btn-default"><i class="fa fa-angle-double-left"></i> Back</button></a>
            </div>
        ...
        <div class="box-body">
         ...
         <form class="form-row" action="<?php echo base_url('pre/update/').$idsoal ?>" method="post" enctype="multipart/form-data">

          <div class="form-group col-md-6">
              <label>Materi</label>
              <input required="" type="text" name="pre_judul" class="form-control" value="<?php echo $judul ?>"> 
            </div>

           <div class="form-group col-md-6">
             <label>Pelajaran</label>
             <select id="pelajaran" name="pre_pelajaran" class="form-control">
           ...
           <div class="form-group col-md-4">
             <label>Kelas</label>
             <select id="kelas" name="pre_kelas[]" class="form-control select2" multiple="multiple" data-placeholder="-- Pilih --"
                      style="width: 100%;">
           ...
           <div class="form-group col-md-4">
              ...
              <input required="" type="datetime-local" name="pre_pelaksanaan" class="form-control" value="<?php echo str_replace(' ','T',$tanggal) ?>"> 
            </div>
            
            <div class="form-group col-md-4">
              <label>Durasi</label>
              <input required="" type="number" name="pre_durasi" class="form-control" value="<?php echo $durasi?>"> 
            </div>

            <div class="form-group col-md-12">
              <label>Petunjuk Pengerjaan</label>
              <textarea required="" class="form-control" name="pre_petunjuk"><?php echo $petunjuk ?></textarea>
            </div>
           
           <div hidden="" class="form-group col-md-3">
             <label>ID Soal</label>
             <input readonly="" value="<?php echo $idsoal ?>" type="text" name="pre_id" class="form-control">
           </div>

           <div hidden="" class="form-group col-md-3">
             <label>Jumlah Soal</label>
             <input readonly="" value="<?php echo $jumlah ?>" type="number" name="pre_jumlah" class="form-control">
           </div>
             ...
             <div class="form-group row">
              <div class="col-xs-12 col-lg-6">
                ...
                <div class="col-lg-11 form-group">
                  ...
                  <?php if (@GetImageSize(base_url('assets/img/pre/').$soal[$i]['gambar'.$i].'.jpeg')): ?>
                    
                    <a href="<?php echo base_url('assets/img/pre/').$soal[$i]['gambar'.$i].'.jpeg' ?>" target="_blank"><button style="margin-top: 1%;" type="button" class="btn btn-default btn-xs"><i class="fa fa-eye"></i> view image</button></a>
                ...
                <div class="col-lg-11 form-group">
                  ...
                  <?php if (@GetImageSize(base_url('assets/img/pre/').$soal[0]['pre_id'].'_a_'.$i.'.jpeg')): ?>
                    
                    <a href="<?php echo base_url('assets/img/pre/').$soal[0]['pre_id'].'_a_'.$i.'.jpeg' ?>" target="_blank"><button style="margin-top: 1%;" type="button" class="btn btn-default btn-xs"><i class="fa fa-eye"></i> view image</button></a>
                ...
                <div class="col-lg-11 form-group">
                  ...
                  <?php if (@GetImageSize(base_url('assets/img/pre/').$soal[0]['pre_id'].'_b_'.$i.'.jpeg')): ?>
                    
                    <a href="<?php echo base_url('assets/img/pre/').$soal[0]['pre_id'].'_b_'.$i.'.jpeg' ?>" target="_blank"><button style="margin-top: 1%;" type="button" class="btn btn-default btn-xs"><i class="fa fa-eye"></i> view image</button></a>
                ...
                <div class="col-lg-11 form-group">
                  ...
                  <?php if (@GetImageSize(base_url('assets/img/pre/').$soal[0]['pre_id'].'_c_'.$i.'.jpeg')): ?>
                    
                    <a href="<?php echo base_url('assets/img/pre/').$soal[0]['pre_id'].'_c_'.$i.'.jpeg' ?>" target="_blank"><button style="margin-top: 1%;" type="button" class="btn btn-default btn-xs"><i class="fa fa-eye"></i> view image</button></a>
                ...
                <div class="col-lg-11 form-group">
                  ...
                  <?php if (@GetImageSize(base_url('assets/img/pre/').$soal[0]['pre_id'].'_d_'.$i.'.jpeg')): ?>
                    
                    <a href="<?php echo base_url('assets/img/pre/').$soal[0]['pre_id'].'_d_'.$i.'.jpeg' ?>" target="_blank"><button style="margin-top: 1%;" type="button" class="btn btn-default btn-xs"><i class="fa fa-eye"></i> view image</button></a>
