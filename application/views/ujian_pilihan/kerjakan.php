...
<form action="<?php echo base_url('ujian_pilihan/hasil/').$idsoal ?>" method="post" enctype="multipart/form-data">
    ...
    <section class="content">
      ...
      <div class="box"> 
        ...
        <div class="col-md-2" style="float: right; padding-right: 0;">
            <input type="text" value="Kesempatan : <?php echo $kesempatan+1 ?>" class="form-control">
            <input type="hidden" name="kesempatan" value="<?php echo $kesempatan ?>">
        </div>
          ...
          <?php endif ?>
            ...
            <?php if ($soal[$i]['soal_input'.$i] == 'image'): ?>
                ...
                <?php if (@getimagesize(base_url('assets/img/ujian_pilihan/').$soal[0]['ujian_pilihan_id'].'_a_'.$i.'.jpeg')): ?>
                    ...
                    <p><input type="radio" name="soal_jawaban<?php echo $i; ?>" value="A">&#160;&#160;&#160;&#160;&#160;&#160;<img class="img-thumbnail" width="100" src="<?php echo base_url('assets/img/ujian_pilihan/').$soal[0]['ujian_pilihan_id'].'_a_'.$i.'.jpeg' ?>"></p>

                <?php endif ?>

                <?php if (@getimagesize(base_url('assets/img/ujian_pilihan/').$soal[0]['ujian_pilihan_id'].'_b_'.$i.'.jpeg')): ?>
                
                    <p><input type="radio" name="soal_jawaban<?php echo $i; ?>" value="B">&#160;&#160;&#160;&#160;&#160;&#160;<img class="img-thumbnail" width="100" src="<?php echo base_url('assets/img/ujian_pilihan/').$soal[0]['ujian_pilihan_id'].'_b_'.$i.'.jpeg' ?>"></p>

                <?php endif ?>

                <?php if (@getimagesize(base_url('assets/img/ujian_pilihan/').$soal[0]['ujian_pilihan_id'].'_c_'.$i.'.jpeg')): ?>
                
                    <p><input type="radio" name="soal_jawaban<?php echo $i; ?>" value="C">&#160;&#160;&#160;&#160;&#160;&#160;<img class="img-thumbnail" width="100" src="<?php echo base_url('assets/img/ujian_pilihan/').$soal[0]['ujian_pilihan_id'].'_c_'.$i.'.jpeg' ?>"></p>

                <?php endif ?>

                <?php if (@getimagesize(base_url('assets/img/ujian_pilihan/').$soal[0]['ujian_pilihan_id'].'_d_'.$i.'.jpeg')): ?>
                
                    <p><input type="radio" name="soal_jawaban<?php echo $i; ?>" value="D">&#160;&#160;&#160;&#160;&#160;&#160;<img class="img-thumbnail" width="100" src="<?php echo base_url('assets/img/ujian_pilihan/').$soal[0]['ujian_pilihan_id'].'_d_'.$i.'.jpeg' ?>"></p>
