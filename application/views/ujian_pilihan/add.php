    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
         ...
         <form class="form-row" action="<?php echo base_url('ujian_pilihan/insert') ?>" method="post" enctype="multipart/form-data">
            
          <input type="hidden" name="ujian_pilihan_semester" value="<?php echo $semester ?>">
          <input type="hidden" name="ujian_pilihan_pertemuan" value="<?php echo $pertemuan ?>">

          <div class="form-group col-md-6">
            <label>Materi</label>
            <input required="" type="text" name="ujian_pilihan_judul" class="form-control" value="">
          </div>
           ...
           <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
              ...
              <input required="" type="datetime-local" name="ujian_pilihan_pelaksanaan" class="form-control"> 
            </div>
            
            <div class="form-group col-md-6">
              <label>Durasi</label>
              <input required="" type="number" name="ujian_pilihan_durasi" class="form-control"> 
            </div>
            
            <div class="form-group col-md-6">
              <label>Kesempatan</label>
              <input required="" type="number" name="ujian_pilihan_kesempatan" class="form-control"> 
            </div>
            ...
            <div class="form-group col-md-12">
              ...
              <textarea required="" class="form-control" name="ujian_pilihan_petunjuk"></textarea>
            </div>

           <div hidden="" class="form-group col-md-3">
             <label>ID Soal</label>
             <input value="<?php echo $idsoal ?>" type="text" name="ujian_pilihan_id" class="form-control">
           </div>
           ...
           <?php for ($i = 0; $i < $jumlah; $i++): ?> 
             ...
             <div class="form-group row">
              ...
              <div class="col-lg-11 form-group">
                <input type="text" required="" class="input<?php echo $i+1; ?> form-control" name="a<?php echo $i+1; ?>" accept="image/*">
              </div>
              <div class="col-lg-1"><label>B. </label></div>
              <div class="col-lg-11 form-group">
                <input type="text" required="" class="input<?php echo $i+1; ?> form-control" name="b<?php echo $i+1; ?>" accept="image/*">
              </div><div class="col-lg-1"><label>C. </label></div>
              <div class="col-lg-11 form-group">
                <input type="text" required="" class="input<?php echo $i+1; ?> form-control" name="c<?php echo $i+1; ?>" accept="image/*">
              </div>
              <div class="col-lg-1"><label>D. </label></div>
              <div class="col-lg-11 form-group">
                <input type="text" required="" class="input<?php echo $i+1; ?> form-control" name="d<?php echo $i+1; ?>" accept="image/*">
              </div>
