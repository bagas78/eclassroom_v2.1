    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
         ...
         <form class="form-row" action="<?php echo base_url('pilihan/insert') ?>" method="post" enctype="multipart/form-data">
           ...
           <div class="form-group col-md-6">
             <label>Acak Soal</label>
              <select required="" id="acak" name="pilihan_acak" class="form-control">
                <option value="">-- Pilih --</option>
                <option value="ya">Ya</option>
                <option value="tidak">Tidak</option>
              </select>
              <script type="text/javascript">
                $('#acak').val('<?php echo $acak; ?>').change();
              </script>
           </div>

           <div hidden="" class="form-group col-md-3">
             <label>ID Soal</label>
             <input value="<?php echo $idsoal ?>" type="text" name="pilihan_id" class="form-control">
           </div>
             ...
             <div class="form-group row">
              <div class="col-xs-12 col-lg-6">
                ...
                <div class="col-lg-11 form-group">
                  ...
                  <input type="hidden" id="file<?php echo $i+1; ?>" name="gambar<?php echo $i+1; ?>" value="<?php echo $idsoal.'_' ?><?php echo $i+1; ?>">
                </div>
              </div>
              <div class="col-xs-12 col-lg-6">
