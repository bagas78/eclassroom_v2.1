...
<a href="<?php echo base_url('pilihan/koreksi') ?>"><button style="background: white;" class="btn btn-default" type="button"></i><i class="fa fa-angle-double-left"></i> Back</button></a>
