    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border"> 
            ...
            <div align="left" > 
              <a href="<?php echo base_url('pilihan'); ?>"><button class="btn btn-default"><i class="fa fa-angle-double-left"></i> Back</button></a>
            </div>
        ...
        <div class="box-body">
         ...
         <form class="form-row" action="<?php echo base_url('pilihan/update/').$idsoal ?>" method="post" enctype="multipart/form-data">
           <div class="form-group col-md-12">
             <label>Judul Pertanyaan</label>
             <input value="<?php echo $judul ?>" type="text" name="pilihan_judul" class="form-control">
           </div>
           ...
           <div class="form-group col-md-6">
             <label>Kelas</label>
             <select id="kelas" name="pilihan_kelas[]" class="form-control select2" multiple="multiple" data-placeholder="-- Pilih --"
                      style="width: 100%;">
           ...
           <div hidden="" class="form-group col-md-3">
             <label>ID Soal</label>
             <input readonly="" value="<?php echo $idsoal ?>" type="text" name="pilihan_id" class="form-control">
           </div>

           <div hidden="" class="form-group col-md-3">
             <label>Jumlah Soal</label>
             <input readonly="" value="<?php echo $jumlah ?>" type="number" name="pilihan_jumlah" class="form-control">
           </div>
              ...
              <div class="col-xs-12 col-lg-6">
                ...
                <div class="col-lg-11 form-group">
                  ...
                  <?php if (@GetImageSize(base_url('assets/img/pilihan/').$soal[$i]['gambar'.$i].'.jpeg')): ?>
                    ...
                    <a href="<?php echo base_url('assets/img/pilihan/').$soal[$i]['gambar'.$i].'.jpeg' ?>" target="_blank"><button style="margin-top: 1%;" type="button" class="btn btn-default btn-xs"><i class="fa fa-eye"></i> view image</button></a>
