        ...
        <div class="box-body">
          ...
          <form style="background: ghostwhite;padding: 2%;border-radius: 15px;" method="POST" action="<?php echo base_url('panduan/save') ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input required="" id="video" type="text" name="panduan_video" class="form-control" placeholder="example : https://www.youtube.com/watch?v=TZVOzUPsVoI" value="<?= 'https://www.youtube.com/watch?v='.@$data['panduan_video'] ?>">
