                ...
                <?php foreach ($data as $key): ?>
                  ...
                  <tr>
                    ...
                    <td style="width: 80px;">
                      ...
                      <button onclick="del('<?php echo base_url() ?>admin/delete/<?php echo $key['user_id'] ?>')" class="btn btn-xs btn-default"><i class="fa fa-trash"></i></button>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form role="form" method="post" action="<?php echo base_url() ?>admin/update/<?php echo $key['user_id'] ?>" enctype="multipart/form-data">
                            <div class="box-body">
                              ...
                              <div class="form-group">
                                <label>Email</label>
                                <input required="" type="email" name="email" class="form-control" placeholder="Email" value="<?php echo $key['user_email'] ?>">
                              </div>
                            </div>
                            <!-- /.box-body -->
                        ...
                        <div class="modal-body">
                          <form>
                            <div class="box-body">
                              ...
                              <div class="form-group">
                                <label>Email</label>
                                <input readonly="" type="email" class="form-control" value="<?php echo $key['user_email'] ?>" placeholder="Belum di isi">
                              </div>
                              <div class="form-group">
                                <label>No. HP</label>
  ...
  <div class="modal fade" id="modal-album">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form role="form" method="post" action="<?php echo base_url() ?>admin/add" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="form-group">
                      <label>Nama</label>
                    ...
                    <div class="form-group">
                      <label>Email</label>
                      <input required="" type="admin" name="email" class="form-control" placeholder="Email">
                    </div>
                  </div>
                  <!-- /.box-body -->
