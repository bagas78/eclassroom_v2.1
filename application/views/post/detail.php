...
<div class="box">
    <div class="box-body">
     <h4><?php echo $soal[0]['post_judul'] ?></h4>
    </div>
</div> 
      ...
      <?php endif ?>
        ...
        <?php if ($soal[$i]['soal_input'.$i] == 'image'): ?>
                ...
                <?php if (@getimagesize(base_url('assets/img/post/').$soal[0]['post_id'].'_a_'.$i.'.jpeg')): ?>
                    ...
                    <p><input id="jawaban-A<?php echo $i; ?>" type="radio" name="soal_jawaban<?php echo $i; ?>" value="A">&#160;&#160;&#160;&#160;&#160;&#160;<img class="img-thumbnail" width="100" src="<?php echo base_url('assets/img/post/').$soal[0]['post_id'].'_a_'.$i.'.jpeg' ?>"> <span></span></p>

                <?php endif ?>

                <?php if (@getimagesize(base_url('assets/img/post/').$soal[0]['post_id'].'_b_'.$i.'.jpeg')): ?>
                
                    <p><input id="jawaban-B<?php echo $i; ?>" type="radio" name="soal_jawaban<?php echo $i; ?>" value="B">&#160;&#160;&#160;&#160;&#160;&#160;<img class="img-thumbnail" width="100" src="<?php echo base_url('assets/img/post/').$soal[0]['post_id'].'_b_'.$i.'.jpeg' ?>"> <span></span></p>

                <?php endif ?>

                <?php if (@getimagesize(base_url('assets/img/post/').$soal[0]['post_id'].'_c_'.$i.'.jpeg')): ?>
                
                    <p><input id="jawaban-C<?php echo $i; ?>" type="radio" name="soal_jawaban<?php echo $i; ?>" value="C">&#160;&#160;&#160;&#160;&#160;&#160;<img class="img-thumbnail" width="100" src="<?php echo base_url('assets/img/post/').$soal[0]['post_id'].'_c_'.$i.'.jpeg' ?>"> <span></span></p>

                <?php endif ?>

                <?php if (@getimagesize(base_url('assets/img/post/').$soal[0]['post_id'].'_d_'.$i.'.jpeg')): ?>
                
                    <p><input id="jawaban-D<?php echo $i; ?>" type="radio" name="soal_jawaban<?php echo $i; ?>" value="D">&#160;&#160;&#160;&#160;&#160;&#160;<img class="img-thumbnail" width="100" src="<?php echo base_url('assets/img/post/').$soal[0]['post_id'].'_d_'.$i.'.jpeg' ?>"> <span></span></p>
...
<a href="<?php echo base_url('post/hasil_view') ?>"><button style="background: white;" class="btn btn-default" type="button"></i><i class="fa fa-angle-double-left"></i> Back</button></a>
