    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
         ...
         <form class="form-row" action="<?php echo base_url('post/insert') ?>" method="post" enctype="multipart/form-data">

          <input type="hidden" name="post_semester" value="<?php echo $semester ?>">
          <input type="hidden" name="post_pertemuan" value="<?php echo $pertemuan ?>">

          <div class="form-group col-md-4">
            <label>Materi</label>
            <input required="" type="text" name="post_judul" class="form-control" value="">
          </div>
           ...
           <div class="form-group col-md-4">
            ...
            <div class="form-group col-md-4">
              ...
              <input required="" type="datetime-local" name="post_pelaksanaan" class="form-control"> 
            </div>
            
            <div class="form-group col-md-4">
              <label>Durasi</label>
              <input required="" type="number" name="post_durasi" class="form-control"> 
            </div>
            
            <div class="form-group col-md-4">
              <label>Kesempatan <small class="text-danger">( mengulang di jam yang sama )</small></label>
              <input readonly="" required="" type="number" name="" value="2" class="form-control"> 
            </div>

            <div class="form-group col-md-12">
              <label>Petunjuk Pengerjaan</label>
              <textarea required="" class="form-control" name="post_petunjuk"></textarea>
            </div>

           <div hidden="" class="form-group col-md-3">
             <label>ID Soal</label>
             <input value="<?php echo $idsoal ?>" type="text" name="post_id" class="form-control">
           </div>
           ...
           <?php for ($i = 0; $i < $jumlah; $i++): ?> 
             ...
             <div class="form-group row">
              ...
              <div class="col-lg-11 form-group">
                <input class="input<?php echo $i+1; ?> form-control" accept="image/*" type="text" required="" name="a<?php echo $i+1; ?>">
              </div>
              <div class="col-lg-1"><label>B. </label></div>
              <div class="col-lg-11 form-group">
                <input class="input<?php echo $i+1; ?> form-control" accept="image/*" type="text" required="" name="b<?php echo $i+1; ?>">
              </div><div class="col-lg-1"><label>C. </label></div>
              <div class="col-lg-11 form-group">
                <input class="input<?php echo $i+1; ?> form-control" accept="image/*" type="text" required="" name="c<?php echo $i+1; ?>">
              </div>
              <div class="col-lg-1"><label>D. </label></div>
              <div class="col-lg-11 form-group">
                <input class="input<?php echo $i+1; ?> form-control" accept="image/*" type="text" required="" name="d<?php echo $i+1; ?>">
              </div>
