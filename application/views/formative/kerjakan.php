...
<form action="<?php echo base_url('formative/hasil/').$idsoal ?>" method="post" enctype="multipart/form-data">
          ...
          <?php endif ?>
            ...
            <?php if ($soal[$i]['soal_input'.$i] == 'image'): ?>
                ...
                <?php if (@getimagesize(base_url('assets/img/formative/').$soal[0]['formative_id'].'_a_'.$i.'.jpeg')): ?>
                    ...
                    <p><input type="radio" name="soal_jawaban<?php echo $i; ?>" value="A">&#160;&#160;&#160;&#160;&#160;&#160;<img class="img-thumbnail" width="100" src="<?php echo base_url('assets/img/formative/').$soal[0]['formative_id'].'_a_'.$i.'.jpeg' ?>"></p>

                <?php endif ?>

                <?php if (@getimagesize(base_url('assets/img/formative/').$soal[0]['formative_id'].'_b_'.$i.'.jpeg')): ?>
                
                    <p><input type="radio" name="soal_jawaban<?php echo $i; ?>" value="B">&#160;&#160;&#160;&#160;&#160;&#160;<img class="img-thumbnail" width="100" src="<?php echo base_url('assets/img/formative/').$soal[0]['formative_id'].'_b_'.$i.'.jpeg' ?>"></p>

                <?php endif ?>

                <?php if (@getimagesize(base_url('assets/img/formative/').$soal[0]['formative_id'].'_c_'.$i.'.jpeg')): ?>
                
                    <p><input type="radio" name="soal_jawaban<?php echo $i; ?>" value="C">&#160;&#160;&#160;&#160;&#160;&#160;<img class="img-thumbnail" width="100" src="<?php echo base_url('assets/img/formative/').$soal[0]['formative_id'].'_c_'.$i.'.jpeg' ?>"></p>

                <?php endif ?>

                <?php if (@getimagesize(base_url('assets/img/formative/').$soal[0]['formative_id'].'_d_'.$i.'.jpeg')): ?>
                
                    <p><input type="radio" name="soal_jawaban<?php echo $i; ?>" value="D">&#160;&#160;&#160;&#160;&#160;&#160;<img class="img-thumbnail" width="100" src="<?php echo base_url('assets/img/formative/').$soal[0]['formative_id'].'_d_'.$i.'.jpeg' ?>"></p>
