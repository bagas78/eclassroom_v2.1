    ...
    <section class="content">
      ...
      <div class="box"> 
        ...
        <div class="box-body">
          ...
          <form method="POST" action="<?php echo base_url('peta/save') ?>" enctype="multipart/form-data">
            <div class="form-group">
              <label>Kelas</label>
              <select id="kelas" name="peta_kelas[]" class="form-control select2" multiple="multiple" data-placeholder="-- Pilih --"
                      style="width: 100%;">
              ...
              <script type="text/javascript">
                $('#kelas').val([<?php echo $data['peta_kelas']; ?>]).change();
              </script>
          ...
          <a href="<?php echo base_url('peta') ?>"><button type="button" class="btn btn-default"><i class="fa fa-times"></i> Batal</button></a>
